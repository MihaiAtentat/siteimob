...
const AgentContact = ({
  ...
  agentTitle,
  agentPhone,
  agentImage = "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",
}: AgentContactProps) => {
  return (
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            <span className="text-red-600 font-medium">{agentPhone}</span>
          </div>
        </div>
      </div>
